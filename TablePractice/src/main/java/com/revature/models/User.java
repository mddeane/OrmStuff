 ...
 * This is a standard design pattern used for objects within Enterprise Application
 * 
...
public class User implements Serializable {
	...
	// this constructor is to create a user from the app and give it an ID
	// after it has been persisted and I can return the ID generated by PostgreSQL
	...
	@Override
	public int hashCode() { // Set uses this
		final int prime = 31;
		int result = 1;
